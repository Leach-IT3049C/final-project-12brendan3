...
function addCircleButton(locX, locY, radius, color, text, textSize, callback, remove = true) { // Adds circle button to array to be drawn
  buttons.unshift({type: `circle`, x: locX, y: locY, radius: radius, color: color, text: text, textSize: textSize, callback: callback, remove: remove});
}
...
function addRectButton(locX, locY, width, height, color, text, textSize, callback, remove = true) { // Adds rectangle button to array to be drawn
  buttons.unshift({type: `rectangle`, x: locX, y: locY, width: width, height: height, color: color, text: text, textSize: textSize, callback: callback, remove: remove});
}
